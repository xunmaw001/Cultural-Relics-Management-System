				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="weixiushuoming" id="weixiushuoming" placeholder="维修说明" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">维修时间</label>
							<div class="layui-input-block">
								<input type="text" name="weixiushijian" id="weixiushijian" placeholder="维修时间" autocomplete="off" class="layui-input">
							</div>
						</div>
