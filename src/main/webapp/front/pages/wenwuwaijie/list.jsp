          ...
          <form class="layui-form">
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="wenwumingcheng" id="wenwumingcheng" placeholder="文物名称" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-bottom: 10px;">
              <label class="layui-form-label">文物分类</label>
              <div class="layui-input-inline">
                <input type="text" name="wenwufenlei" id="wenwufenlei" placeholder="文物分类" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-bottom: 10px;">
              <label class="layui-form-label">借用单位</label>
              <div class="layui-input-inline">
                <input type="text" name="jieyongdanwei" id="jieyongdanwei" placeholder="借用单位" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
              ...
              <button v-if="isAuth('wenwuwaijie','新增')" @click="jump('../wenwuwaijie/add.jsp')" type="button" class="layui-btn btn-theme">
        ...
        <div class="pro-lists-con">
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../wenwuwaijie/detail.jsp?id='+item.id">
                <div class="posi-img">
                </div>
                <div class="remark">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#wenwumingcheng').val()) {
          param['wenwumingcheng'] = jquery('#wenwumingcheng').val() ? '%' + jquery('#wenwumingcheng').val() + '%' : '';
        }  
        if (jquery('#wenwufenlei').val()) {
          param['wenwufenlei'] = jquery('#wenwufenlei').val() ? '%' + jquery('#wenwufenlei').val() + '%' : '';
        }  
        if (jquery('#jieyongdanwei').val()) {
          param['jieyongdanwei'] = jquery('#jieyongdanwei').val() ? '%' + jquery('#jieyongdanwei').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('wenwuwaijie/list', 'get', param, function(res) {
