					...
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="wenwubianhao" id="wenwubianhao" placeholder="文物编号" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="waijieshiyou" id="waijieshiyou" placeholder="外借事由" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">外借日期</label>
							<div class="layui-input-block">
								<input type="text" name="waijieriqi" id="waijieriqi" placeholder="外借日期" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
