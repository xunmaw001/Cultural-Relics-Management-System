		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
                        ...
                        <div class="layui-input-block">
                            <select name="wenwufenlei" id="wenwufenlei" lay-filter="wenwufenlei">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in wenwufenlei" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																								...
                																								http.request(`option/wenwufenlei/wenwufenlei`,'get',{},(res)=>{
					vue.wenwufenlei = res.data
				});
																// 上传图片
				...
				form.on('submit(*)', function(data) {
					...
					// 提交数据
					http.requestJson('wenwuxinxi' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
