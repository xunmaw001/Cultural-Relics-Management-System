				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<select name="wenwufenlei" id="wenwufenlei">
							...
							<div class="layui-input-block">
								<button type="button" class="layui-btn btn-theme" id="tupianUpload">
									<i class="layui-icon">&#xe67c;</i>上传图片
                                                                                                                                                                        ...
                                                                                                                                                                        <div class="layui-form-item">
							<label class="layui-form-label">文物介绍</label>
							<div class="layui-input-block">
								<input type="text" name="wenwujieshao" id="wenwujieshao" placeholder="文物介绍" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
