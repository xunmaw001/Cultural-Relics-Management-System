				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('wenwuxinxi','外借')" @click="onAcrossTap('wenwuwaijie')" type="button" class="layui-btn">
								外借
							</button>
																					<button v-if="isAuth('wenwuxinxi','维修')" @click="onAcrossTap('wenwuweixiu')" type="button" class="layui-btn">
								维修
							</button>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`wenwuxinxi`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
																									vue.title = vue.detail.wenwumingcheng;
																														// 轮播图片
